...
import { getAnimeByTitle } from '../Services/ani-service'; // importamos la función getAnimeByTitle del archivo ani-service.ts
import { parse } from "dotenv";

export const searchAnime = async (req: Request, res: Response): Promise<void> => { // definimos una función asíncrona que recibe una petición y una respuesta y devuelve una promesa de tipo void
