...
import { getAllCharactersByAnime, getCharacter, searchAnimeById, searchAnimeByTitle } from '../Controllers/ani-controller'; // importamos la función searchAnime del archivo ani-controller.ts
...
router.get('/character', getCharacter); // definimos una ruta GET en el router que llama a la función searchAnime
